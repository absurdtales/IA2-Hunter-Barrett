...
class Ui_LoginWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.register_btn.clicked.connect(lambda: self.registeruser(usernameDB, passwordDB, emailDB))
    ...
    def registeruser(self, usernameDB, passwordDB, emailDB):
        UserDB.create_user(self, username= usernameDB, password= passwordDB, email= emailDB)
